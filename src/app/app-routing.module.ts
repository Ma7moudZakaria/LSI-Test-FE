...
const routes: Routes = [
  ...
  { path: 'admin-student', loadChildren: () => import('./modules/admin-stu-tab/admin-stu-tab-routing.module').then(m => m.AdminStuTabRoutingModule), canActivate: [AuthGuard] },
  { path: 'admin-taecher', loadChildren: () => import('./modules/admin-teacher-tab/admin-teacher-tab.module').then(m => m.AdminTeacherTabModule), canActivate: [AuthGuard] },
