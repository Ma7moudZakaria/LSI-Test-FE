...
@Component({
  selector: 'app-program-attache-exam-templats',
  templateUrl: './program-attache-exam-templats.component.html',
  styleUrls: ['./program-attache-exam-templats.component.scss']
})
export class ProgramAttacheExamTemplatsComponent implements OnInit {
