...
@Component({
  selector: 'app-user-scientific-problem-list-view',
  templateUrl: './user-scientific-problem-list-view.component.html',
  styleUrls: ['./user-scientific-problem-list-view.component.scss']
})
export class UserScientificProblemListViewComponent implements OnInit {
