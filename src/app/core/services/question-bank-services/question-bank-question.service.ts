...
import { IAddScProbToQuestionBank } from '../../interfaces/scientific-problrm/iadd-sc-prob-to-question-bank';
...
export class QuestionBankQuestionService {
  ...
  moveScProbToQuestionBankUrl = environment.baseUrl + 'QuestionBankQuestions/move-scientific-problem-to-question-bank/';
  ...
  moveScProbToQuestionBank(model : IAddScProbToQuestionBank): Observable<BaseResponseModel>{
    return this.http.post<BaseResponseModel>(this.moveScProbToQuestionBankUrl, model)
  }
}
